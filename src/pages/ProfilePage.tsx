  ...
  return (
    <div className="min-h-screen gradient-bg pb-20">
      ...
      <div className="px-5 pt-12 pb-6 text-center">
        ...
        <p className="text-sm text-primary mt-1">● En ligne</p>
      ...
      <div className="px-5 space-y-2">
        {menuItems.map((item, i) => (
          <motion.button
            ...
            className="w-full glass rounded-xl p-4 flex items-center gap-3 hover:bg-secondary/30 active:scale-[0.98] transition-all"
          >
        ...
        <motion.button
          ...
          className="w-full glass rounded-xl p-4 flex items-center gap-3 hover:bg-destructive/10 active:scale-[0.98] transition-all"
        >
